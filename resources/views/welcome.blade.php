...
<body class="bg-gray-50">
        ...
        <div class="container mx-auto px-4 py-16">
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="md:w-1/2 text-white" data-aos="fade-right">
                    ...
                    <p class="text-xl mb-8">Melindungi dan melayani masyarakat Kudus dengan kesiapsiagaan dan penanganan bencana yang profesional.</p>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-gray-600">Program edukasi dan pelatihan untuk meningkatkan kesiapsiagaan masyarakat.</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="space-y-4" data-aos="fade-up">
                    <div class="overflow-hidden rounded-xl">
                        <img src="{{ asset('images/kegiatan1.jpg') }}" alt="Kegiatan 1" class="gallery-img w-full h-64 object-cover">
                    </div>
                    <h3 class="text-xl font-bold">Pelatihan Relawan</h3>
                    <p class="text-gray-600">Program pelatihan rutin untuk meningkatkan kapasitas relawan BPBD Kudus.</p>
                ...
                <div class="space-y-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="overflow-hidden rounded-xl">
                        <img src="{{ asset('images/kegiatan3.jpg') }}" alt="Kegiatan 3" class="gallery-img w-full h-64 object-cover">
                    </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div data-aos="fade-right">
                    ...
                    <p class="text-gray-600 mb-8">Untuk informasi lebih lanjut atau bantuan darurat, silakan hubungi kami melalui:</p>
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Jl. PG Rendeng, Mlati Norowito, Kec. Kota Kudus, Kabupaten Kudus, Jawa Tengah 59319</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-blue-200">Melindungi dan melayani masyarakat Kudus dengan kesiapsiagaan dan penanganan bencana yang profesional.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="https://www.facebook.com/bpbdkuduskab/?locale=id_ID" class="bg-blue-800 p-2 rounded-full hover:bg-blue-700 transition duration-300">
            ...
            <div class="border-t border-blue-800 mt-8 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex space-x-4 mt-4 md:mt-0">
                        ...
                        <a href="https://maps.app.goo.gl/TqL4Cp4HJXyz1suo8" class="text-blue-200 hover:text-white">Peta Situs</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Back to Top Button -->
    <button id="backToTop" class="fixed bottom-8 right-8 bg-blue-600 text-white p-3 rounded-full shadow-lg hidden hover:bg-blue-700 transition duration-300">
